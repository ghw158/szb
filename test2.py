...
def perform_full_actions(device):
    ...
    if len(g_xlist) == 0:
        ...
        while atk_flag:
            ...
            if len(you_xlist) != 0:
                if len(g_xlist) != 0:
                    curved_drag(device, you_xlist[(-1 - atk_num) % len(you_xlist)], start_y, g_xlist[0], 238, 0.04)
                    loop_count += 1
                    time.sleep(1)
                    ...
                    curved_drag(device, you_xlist[(-1 - atk_num) % len(you_xlist)], start_y, end_x, end_y, 0.04)
                    loop_count += 1
                    atk_num += 1
            else:
                atk_flag = False
